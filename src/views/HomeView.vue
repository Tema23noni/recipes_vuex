<template>
 <div class="home">
  <h1>Мои рецепты</h1>
  <button @click="togglePopup">Добавить новый рецепт</button>
   ...
   <div class="popup-content">
    ...
    <form @submit.prevent="addNewRecipe">
     ...
     <div class="group">
      ...
      <button type="button" @click="addNewIngredient">Добавить ингредиенты</button>
     </div>

     <div class="group">
      <label>Методы приготовления</label>
